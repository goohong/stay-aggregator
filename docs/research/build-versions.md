...
| 확인한 것 | 값 | 원문 |
|---|---|---|
| 최신 정식 릴리스 | 4.1.1 (4.0.8, 3.5.16, 3.4.13 도 존재). 2026-09-15 재대조 때 메타데이터의 최신 표시는 마일스톤 4.2.0-M1 | [메타데이터](https://repo1.maven.org/maven2/org/springframework/boot/spring-boot-starter/maven-metadata.xml) |
