...
| 4 | Expedia Rapid Java SDK (API 명세에서 생성) | [Rate.kt](https://github.com/ExpediaGroup/rapid-java-sdk/blob/main/code/src/main/kotlin/com/expediagroup/sdk/rapid/models/Rate.kt) 의 `available_rooms` 주석. `main` 브랜치라 줄 번호는 밀린다 |
